...
There are instructions in the [TextTest Readme in Kata-Github](https://github.com/emilybache/GildedRose-Refactoring-Kata/tree/main/texttests) for setting up TextTest. You will need to specify the Python executable and interpreter in config.gr Uncomment these lines:
